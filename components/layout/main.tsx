          ...
          <div className="mt-[30px]">
            ...
            <div className="mt-[20px] flex justify-between items-center">
              <div className="w-[80%] h-[45px] flex justify-between items-center rounded-[10px] overflow-hidden">
                ...
                >
                  ...
                  {Number(currentPrice).toLocaleString("it-IT", {
                    style: "currency",
                    currency: "VND",
                  })}
                </label>
              ...
              <button
                className="shadow-lg px-[10px] h-[45px] w-[20%] bg-blue-700 rounded-[10px] text-lg text-white font-bold ml-[20px]"
            ...
            <div className="mx-auto w-full">
              ...
              {item?.data.length !== 0 ? (
                item?.data.map((value: CreateNewRoomPayload) => (
                  <div
                    className="flex justify-between items-center p-[10px] overflow-hidden rounded-[10px] shadow-lg border-solid border-[#ADB1C7] border-2 mt-[20px]"
                    key={value._id}
                  >
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center ml-[20px] w-[30%]">
                              ...
                              <p className="ml-[5px] text-green-500">
                                {value?.stateRoom ? "Còn phòng" : "Hết phòng"}
                              </p>
                            </div>
                          </div>
                          <div className="flex">
            ...
            >
              <ReactPaginate
                ...
                pageCount={Number((item?.totalDocument / 4).toFixed(0))}
                previousLabel="<"
