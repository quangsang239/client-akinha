  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-100">
        <div className="flex w-[90%] flex-shrink flex-grow mx-auto justify-between pt-[100px] pb-[30px]">
            ...
            <div className="mx-[30px] my-[20px]">
              <div className="flex flex-col">
                ...
                <input
                  id="username"
                  type="text"
                  className="h-[50px] placeholder:mx-[10px] px-[10px] rounded-[10px] my-[10px] disabled:bg-slate-500 text-white"
                  disabled
                  value="quangsang239"
                />
              </div>
              <div className="flex flex-col">
                ...
                <div className="flex items-center w-full rounded-[10px] my-[10px] text-black border border-slate-500 overflow-hidden justify-between">
                  <input
                    id="username"
                    type="email"
                    className="h-[50px] placeholder:mx-[10px] px-[10px] outline-none w-full disabled:bg-slate-500 disabled:text-white peer"
                    value="quangsang239@gmail.com"
                    disabled
                  />
                  <div className="h-full peer-disabled:bg-slate-500">
                    <svg
                ...
                <p className="text-lg text-green-500 underline-offset-8 hover:cursor-pointer hover:opacity-70">
                  Xác nhận email?
                </p>
              </div>
              <button className="text-lg mt-[10px] w-full h-[50px] bg-blue-500 rounded-[10px] hover:opacity-70">
                Sửa email
              </button>
              <button
                disabled
                className="text-lg mt-[20px] w-full h-[50px] bg-blue-500 rounded-[10px] disabled:bg-slate-500 hover:opacity-70 dis"
              >
                Thêm phòng
              </button>
            </div>
          ...
          <div className="w-[78%] bg-white rounded-[10px]">
            {/* start item */}
            <div className="flex justify-between items-center pb-[30px] border-solid border-slate-200 border-b-2 last:border-none mt-[20px] mx-[50px] hover:cursor-pointer hover:opacity-70">
            ...
            {/* end item */}
            <div className="flex py-[50px] w-full h-[100px] items-center text-xl">
              <ReactPaginate
