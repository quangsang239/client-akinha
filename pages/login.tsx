            ...
            <div className="w-[80%] p-[10%] h-[60%] absolute left-1/2 -translate-x-1/2 z-10 transition duration-[200s] ease-in-out">
              ...
              <div className="group">
                <input
                  ...
                  required
                />
                <label className="label peer-focus:top-[0px] peer-focus:left-[5%] peer-valid:top-[0px] peer-valid:left-[5%]">
                  Username
                </label>
              </div>
              <div className="group">
            ...
            <div className="w-[80%] p-[10%] h-[60%] absolute left-1/2 -translate-x-1/2 z-10 ">
              ...
              <div className="group-register">
                <input
                  ...
                  required
                />
                <label className="label peer-focus:top-[7px] peer-focus:left-[5%] peer-valid:top-[7px] peer-valid:left-[5%]">
                  Username
                </label>
              </div>
              <div className="group-register">
